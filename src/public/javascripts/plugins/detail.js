...
const showMoreDescBtn = document.querySelector(".show-more-desc");

let bool = false;
function showMoreDesc() {
  if (bool === false) {
    showMoreDescBtn.innerHTML = "Show Less <i class='fas fa-angle-up'></i>";
    textDesc.classList.remove("truncate");
    bool = true;
  } else {
    showMoreDescBtn.innerHTML = "Show More <i class='fas fa-angle-down'></i>";
